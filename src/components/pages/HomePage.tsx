            ...
            <div className="flex flex-col gap-8">
              <AnimatedElement className="lg:sticky top-32">
                <div className="relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl">
                  ...
                  <h3 className="absolute bottom-8 left-8 font-heading text-4xl font-bold text-white">Para Clientes</h3>
                </div>
              </AnimatedElement>
                ...
                {clientSteps.map((item, index) => (
                  <AnimatedElement key={index} delay={index * 150}>
                    <div className="flex items-start gap-6">
                      ...
                      <p className="font-paragraph text-lg text-foreground pt-2.5">{item.text}</p>
                    </div>
                  </AnimatedElement>
                ))}
              </div>
            ...
            <div className="flex flex-col gap-8">
              <AnimatedElement className="lg:sticky top-32">
                <div className="relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl">
                  ...
                  <h3 className="absolute bottom-8 left-8 font-heading text-4xl font-bold text-white">Para Joseadores</h3>
                </div>
              </AnimatedElement>
              <div className="space-y-8 mt-8 lg:mt-0">
